 ...
 */
public class Ds implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		panelMain.add(homePage);
		panelMain.add(browseProjectsCard);
		panelMain.add(adminDashboardCard);
		panelMain.add(chapterDashboardCard);
